...
export type getCityOverlaysAndProjectsResponse =
  RouterOutput["cities"]["getCityOverlaysAndProjects"];
...
export type UndoProjectApprovalStatusResponse =
  RouterOutput["moderation"]["undoProjectApprovalStatus"];

export type UndoOverlayApprovalStatusInput = RouterInput["moderation"]["undoOverlayApprovalStatus"];
export type UndoOverlayApprovalStatusResponse =
  RouterOutput["moderation"]["undoOverlayApprovalStatus"];
