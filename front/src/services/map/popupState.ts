...
// The fly offset (mapNavigation) and the placement math below both derive from this value, so
// the predicted on-screen anchor matches where the camera actually lands.
