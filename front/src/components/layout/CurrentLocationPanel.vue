  ...
  for (const standaloneSummary of standaloneProjects) {
    ...
    if (!projectsMap.has(standaloneSummary.id) && standaloneSummary.overlayCount === 0) {
      projectsMap.set(standaloneSummary.id, {
        ...
        timelineStatus: standaloneSummary.timelineStatus ?? "proposed",
        importSourceId: standaloneSummary.importSourceId ?? null,
        externalId: standaloneSummary.externalId ?? null,
        externalProperties: standaloneSummary.externalProperties ?? null,
        externalLastModified: standaloneSummary.externalLastModified ?? null,
        lastImportedAt: standaloneSummary.lastImportedAt ?? null,
