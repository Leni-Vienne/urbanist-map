...
Add two A records pointing to your server IP (`82.67.140.177`):

| Type | Name        | Content       | Proxy Status |
| ---- | ----------- | ------------- | ------------ |
| A    | api         | 82.67.140.177 | Proxied ☁️   |
| A    | preview-api | 82.67.140.177 | Proxied ☁️   |
...
- `REMOTE_HOST` - Server IP address (82.67.140.177)
